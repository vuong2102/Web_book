...
<html>
    ...
    <body>
        ...
        <div class="titleforPhone">
            <div class="title">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4e4b0083=""><path d="M5 9L10 2" stroke="#B5292F" stroke-width="1.8" stroke-miterlimit="10" data-v-4e4b0083=""></path><path d="M19 9L14 2" stroke="#B5292F" stroke-width="1.8" stroke-miterlimit="10" data-v-4e4b0083=""></path><path d="M17 21H6L2 9H22L17 21Z" stroke="#B5292F" stroke-width="1.8" stroke-miterlimit="10" stroke-linecap="square" data-v-4e4b0083=""></path><path d="M4 13H20" stroke="#B5292F" stroke-width="1.8" data-v-4e4b0083=""></path></svg>
                <div class="cartName">Giỏ hàng</div>
            </div>
        </div>
        <div class="address">
                ...
                <div class="cart">
                    <div class="table-cart">
                        <div class="table-head">
                            ...
                            <div class="itemCenter removeItem">Action</div>
                        </div>
                        <div class="list_items">
                            ...
                            <div class="item">
                                ...
                                <form class="itemBuyNow btn-buy" action="order-now" method="post">
                                    <button>
                                        <input type="hidden" name="id" value="<%= c.getId()%>" class="form-input">
                                        <input class="form-control" type="hidden" name="quantity" value="<%=c.getQuantity()%>" readonly>
                ...
                <div class="content-cart">
                    <div class="table-cart-right">
                        <div class="deliveryInformation">
                            <div>Tên: ${sessionScope.auth.userName}</div>
                            <div>SDT: ${sessionScope.auth.phoneNumber}</div>
                            <div>Địa chỉ: ${sessionScope.auth.address}</div>
                        </div>
                        <div class="totalPrice">
                            <div class="name">Total Price</div>
                            <div class="value">$${(totalPrice>0)?dcf.format(totalPrice):0}</div>
                        </div>
                        <div class="buy">
                            <a type="submit" href="cart-check-out" class="btn-buy js-buy">
