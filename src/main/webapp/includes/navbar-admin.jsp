    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav" style="--bs-scroll-height: 100px;">
        ...
        <%
          ...
          <li class="nav-item"><a class="nav-link" href="manage-user?index=1">Manage Account</a></li>
          <li class="nav-item"><a class="nav-link" href="manage-book?index=1">Manage Book</a></li>
          <li class="nav-item"><a class="nav-link" href="manage-order?index=1">Manage Order</a></li>
