...
<body>
    ...
    <div class="content">
        ...
        <div class="information">
            <div class="infoItem">
                <div class="infoTitle">Tên đăng nhập</div>
                <div class="infoData">
